...
var dofDepth = node.in('dofDepth', 3, {
  connectable: false,
  precision: 2,
  min: 0.001,
  max: 20
})
var dofRange = node.in('dofRange', 3, {
  connectable: false,
  precision: 2,
  min: 0.001,
  max: 20
...
var cameraCmp = renderer.camera({
  ...
  dofRange: dofRange.value,
  dofDepth: dofDepth.value,
  dofRadius: dofRadius.value,
  exposure: exposure.value,
  depthPrepass: true
})

var postProcessingCmp = renderer.postProcessing ? renderer.postProcessing() : null
...
dofRadius.onChange = onChange
dofRange.onChange = onChange
dofDepth.onChange = onChange
